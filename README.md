...
```toml
[dependencies]
tauri-plugin-secure-element = "0.1.0-beta.7"
```

Cargo does not treat prereleases as compatible with one another: `"0.1.0-beta.7"` will
**not** resolve to `0.1.0-beta.7`. Bump this line by hand for each beta.
