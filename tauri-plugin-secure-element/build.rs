...
fn main() {
    ...
    // The permissions directory (including autogenerated files) is not excluded by
    // Cargo.toml's exclude field, so it's included in the package and should already
    // be present
